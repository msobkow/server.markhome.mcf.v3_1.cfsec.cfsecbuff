// Description: Java 25 implementation of a SecClusRoleMemb by ClusRoleIdx index key buffer
	...
	implements ICFSecSecClusRoleMembByClusRoleIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusRoleMembByClusRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
