// Description: Java 25 implementation of a TSecGroup by TenantIdx index key buffer
...
public class CFSecBuffTSecGroupByTenantIdxKey
	implements ICFSecTSecGroupByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFSecBuffTSecGroupByTenantIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffTSecGroupByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
