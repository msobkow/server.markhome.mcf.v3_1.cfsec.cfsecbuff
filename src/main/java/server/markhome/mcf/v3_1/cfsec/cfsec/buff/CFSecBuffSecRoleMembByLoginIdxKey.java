// Description: Java 25 implementation of a SecRoleMemb by LoginIdx index key buffer
...
public class CFSecBuffSecRoleMembByLoginIdxKey
	implements ICFSecSecRoleMembByLoginIdxKey, Comparable<Object>, Serializable
{
	protected String requiredLoginId;
	public CFSecBuffSecRoleMembByLoginIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecRoleMembByLoginIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
