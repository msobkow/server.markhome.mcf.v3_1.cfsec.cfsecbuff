// Description: Java 25 implementation of a SecSysGrp by SecLevelNmIdx index key buffer
...
public class CFSecBuffSecSysGrpBySecLevelNmIdxKey
	implements ICFSecSecSysGrpBySecLevelNmIdxKey, Comparable<Object>, Serializable
{
	protected ICFSecSchema.SecLevelEnum requiredSecLevel;
	protected String requiredName;
	public CFSecBuffSecSysGrpBySecLevelNmIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecSysGrpBySecLevelNmIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
