// Description: Java 25 implementation of a ServiceType by UDescrIdx index key buffer
...
public class CFSecBuffServiceTypeByUDescrIdxKey
	implements ICFSecServiceTypeByUDescrIdxKey, Comparable<Object>, Serializable
{
	protected String requiredDescription;
	public CFSecBuffServiceTypeByUDescrIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffServiceTypeByUDescrIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
