// Description: Java 25 implementation of a SecTentRoleMemb history buffer object
...
public class CFSecBuffSecTentRoleMembH
    implements ICFSecSecTentRoleMembH, Comparable<Object>, Serializable
{
    ...
    public CFSecBuffSecTentRoleMembH() {
            ...
            pkey = new CFSecBuffSecTentRoleMembHPKey();
    }
    ...
    public void setPKey( ICFSecSecTentRoleMembHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecTentRoleMembHPKey) {
                this.pkey = (CFSecBuffSecTentRoleMembHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecTentRoleMembHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecTentRoleMembH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
