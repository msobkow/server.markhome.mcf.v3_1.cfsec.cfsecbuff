// Description: Java 25 implementation of a SecRole history buffer object
...
public class CFSecBuffSecRoleH
    implements ICFSecSecRoleH, Comparable<Object>, Serializable
{
    protected CFSecBuffSecRoleHPKey pkey;
    ...
    public CFSecBuffSecRoleH() {
            // The primary key member attributes are initialized on construction
            pkey = new CFSecBuffSecRoleHPKey();
    ...
    public void setPKey( ICFSecSecRoleHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecRoleHPKey) {
                this.pkey = (CFSecBuffSecRoleHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecRoleHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecRoleH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
