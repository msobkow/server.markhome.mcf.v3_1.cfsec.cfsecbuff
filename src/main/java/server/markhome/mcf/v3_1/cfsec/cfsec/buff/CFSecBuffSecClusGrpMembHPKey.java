// Description: Java 25 implementation of a SecClusGrpMemb history buffer primary key
	...
	implements ICFSecSecClusGrpMembHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecClusGrpMembHPKey() {
		...
		requiredSecUserId = CFLibDbKeyHash256.fromHex( ICFSecSecClusGrpMemb.SECUSERID_INIT_VALUE.toString() );
	}
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpMembPKey, ICFSecSecClusGrpMemb, ICFSecSecClusGrpMembHPKey, ICFSecSecClusGrpMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusGrpMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
