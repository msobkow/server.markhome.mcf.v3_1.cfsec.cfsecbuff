// Description: Java 25 implementation of a ISOLang history buffer primary key
...
/**
 *	CFSecBuffISOLangHPKey History Primary Key for ISOLang
 *		requiredISOLangId	Required object attribute ISOLangId.
 */
public class CFSecBuffISOLangHPKey
	implements ICFSecISOLangHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffISOLangHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
