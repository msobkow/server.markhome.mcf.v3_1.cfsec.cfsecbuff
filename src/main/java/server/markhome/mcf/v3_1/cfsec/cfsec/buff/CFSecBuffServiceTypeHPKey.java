// Description: Java 25 implementation of a ServiceType history buffer primary key
...
/**
 *	CFSecBuffServiceTypeHPKey History Primary Key for ServiceType
 *		requiredServiceTypeId	Required object attribute ServiceTypeId.
 */
public class CFSecBuffServiceTypeHPKey
	implements ICFSecServiceTypeHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffServiceTypeHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffServiceTypeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
