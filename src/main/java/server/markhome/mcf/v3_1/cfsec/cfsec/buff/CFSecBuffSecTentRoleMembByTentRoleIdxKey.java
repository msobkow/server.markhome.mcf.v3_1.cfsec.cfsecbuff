// Description: Java 25 implementation of a SecTentRoleMemb by TentRoleIdx index key buffer
	...
	implements ICFSecSecTentRoleMembByTentRoleIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecTentRoleMembByTentRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
