// Description: Java 25 implementation of a SecRoleEnables history buffer primary key
...
/**
 *	CFSecBuffSecRoleEnablesHPKey History Primary Key for SecRoleEnables
 *		requiredSecRoleId	Required object attribute SecRoleId.
 *		requiredEnableName	Required object attribute EnableName.
 */
public class CFSecBuffSecRoleEnablesHPKey
	implements ICFSecSecRoleEnablesHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecRoleEnablesHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecRoleEnablesHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
