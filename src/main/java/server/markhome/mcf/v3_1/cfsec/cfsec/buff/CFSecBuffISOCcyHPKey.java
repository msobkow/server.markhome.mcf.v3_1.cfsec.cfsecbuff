// Description: Java 25 implementation of a ISOCcy history buffer primary key
...
/**
 *	CFSecBuffISOCcyHPKey History Primary Key for ISOCcy
	...
	implements ICFSecISOCcyHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffISOCcyHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
