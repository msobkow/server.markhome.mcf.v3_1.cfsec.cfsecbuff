// Description: Java 25 implementation of a SecSysGrp by UNameIdx index key buffer
...
public class CFSecBuffSecSysGrpByUNameIdxKey
	implements ICFSecSecSysGrpByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecSysGrpByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
