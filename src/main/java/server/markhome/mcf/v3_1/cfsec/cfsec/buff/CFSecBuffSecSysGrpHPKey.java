// Description: Java 25 implementation of a SecSysGrp history buffer primary key
...
/**
 *	CFSecBuffSecSysGrpHPKey History Primary Key for SecSysGrp
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId.
 */
public class CFSecBuffSecSysGrpHPKey
	implements ICFSecSecSysGrpHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecSysGrpHPKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpPKey, ICFSecSecSysGrp, ICFSecSecSysGrpHPKey, ICFSecSecSysGrpH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecSysGrpHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
