// Description: Java 25 implementation of a SecUserEMConf history buffer object
...
public class CFSecBuffSecUserEMConfH
    implements ICFSecSecUserEMConfH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFSecSecUserEMConfHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecUserEMConfHPKey) {
                this.pkey = (CFSecBuffSecUserEMConfHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecUserEMConfHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecUserEMConfH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
