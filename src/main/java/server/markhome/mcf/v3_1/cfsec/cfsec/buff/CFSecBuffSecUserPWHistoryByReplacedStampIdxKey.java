// Description: Java 25 implementation of a SecUserPWHistory by ReplacedStampIdx index key buffer
	...
	implements ICFSecSecUserPWHistoryByReplacedStampIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserPWHistoryByReplacedStampIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
