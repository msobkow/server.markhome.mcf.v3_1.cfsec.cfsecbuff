// Description: Java 25 implementation of a SecDevice history buffer object
...
public class CFSecBuffSecDeviceH
    implements ICFSecSecDeviceH, Comparable<Object>, Serializable
{
    protected CFSecBuffSecDeviceHPKey pkey;
    ...
    public void setPKey( ICFSecSecDeviceHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecDeviceHPKey) {
                this.pkey = (CFSecBuffSecDeviceHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecDeviceHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecDeviceH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
