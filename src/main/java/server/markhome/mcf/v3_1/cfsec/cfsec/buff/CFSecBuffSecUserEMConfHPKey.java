// Description: Java 25 implementation of a SecUserEMConf history buffer primary key
...
/**
 *	CFSecBuffSecUserEMConfHPKey History Primary Key for SecUserEMConf
 *		requiredSecUserId	Required object attribute SecUserId.
 */
public class CFSecBuffSecUserEMConfHPKey
	implements ICFSecSecUserEMConfHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecUserEMConfPKey, ICFSecSecUserEMConf, ICFSecSecUserEMConfHPKey, ICFSecSecUserEMConfH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserEMConfHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
