// Description: Java 25 implementation of a SecUserEMConf by ConfEMAddrIdx index key buffer
	...
	implements ICFSecSecUserEMConfByConfEMAddrIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserEMConfByConfEMAddrIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
