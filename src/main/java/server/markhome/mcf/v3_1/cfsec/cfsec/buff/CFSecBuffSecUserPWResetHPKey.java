// Description: Java 25 implementation of a SecUserPWReset history buffer primary key
...
/**
 *	CFSecBuffSecUserPWResetHPKey History Primary Key for SecUserPWReset
 *		requiredSecUserId	Required object attribute SecUserId.
 */
public class CFSecBuffSecUserPWResetHPKey
	implements ICFSecSecUserPWResetHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecUserPWResetHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserPWResetHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
