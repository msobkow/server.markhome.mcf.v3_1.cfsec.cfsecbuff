// Description: Java 25 implementation of a SecSysGrpInc history buffer object
...
public class CFSecBuffSecSysGrpIncH
    implements ICFSecSecSysGrpIncH, Comparable<Object>, Serializable
{
    ...
    public CFSecBuffSecSysGrpIncH() {
            ...
            pkey = new CFSecBuffSecSysGrpIncHPKey();
    }
    ...
    public void setPKey( ICFSecSecSysGrpIncHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecSysGrpIncHPKey) {
                this.pkey = (CFSecBuffSecSysGrpIncHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecSysGrpIncHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecSysGrpIncH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
