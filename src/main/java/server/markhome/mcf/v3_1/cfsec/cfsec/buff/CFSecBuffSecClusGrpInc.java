// Description: Java 25 implementation of a SecClusGrpInc buffer
...
public class CFSecBuffSecClusGrpInc
	implements ICFSecSecClusGrpInc, Comparable<Object>, Serializable
{
	protected ICFSecSecClusGrpIncPKey pkey = new CFSecBuffSecClusGrpIncPKey();
	...
	public CFSecBuffSecClusGrpInc() {
		pkey = new CFSecBuffSecClusGrpIncPKey();
	}
	...
	public void setPKey(ICFSecSecClusGrpIncPKey pkey ) {
		...
		else if (!(pkey instanceof CFSecBuffSecClusGrpIncPKey)) {
			throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecClusGrpIncPKey");
		}
		this.pkey = (CFSecBuffSecClusGrpIncPKey)pkey;
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusGrpInc" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
