// Description: Java 25 implementation of a ISOCtryLang by CtryIdx index key buffer
...
public class CFSecBuffISOCtryLangByCtryIdxKey
	implements ICFSecISOCtryLangByCtryIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffISOCtryLangByCtryIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
