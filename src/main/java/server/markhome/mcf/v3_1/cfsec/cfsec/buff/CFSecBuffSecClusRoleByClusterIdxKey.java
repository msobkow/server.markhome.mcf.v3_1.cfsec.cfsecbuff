// Description: Java 25 implementation of a SecClusRole by ClusterIdx index key buffer
...
public class CFSecBuffSecClusRoleByClusterIdxKey
	implements ICFSecSecClusRoleByClusterIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusRoleByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
