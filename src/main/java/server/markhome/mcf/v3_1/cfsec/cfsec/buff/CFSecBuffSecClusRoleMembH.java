// Description: Java 25 implementation of a SecClusRoleMemb history buffer object
...
public class CFSecBuffSecClusRoleMembH
    implements ICFSecSecClusRoleMembH, Comparable<Object>, Serializable
{
    ...
    public CFSecBuffSecClusRoleMembH() {
            ...
            pkey = new CFSecBuffSecClusRoleMembHPKey();
    }
    ...
    public void setPKey( ICFSecSecClusRoleMembHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecClusRoleMembHPKey) {
                this.pkey = (CFSecBuffSecClusRoleMembHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecClusRoleMembHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecClusRoleMembH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
