// Description: Java 25 implementation of a ISOTZone history buffer object
...
public class CFSecBuffISOTZoneH
    implements ICFSecISOTZoneH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFSecISOTZoneHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffISOTZoneHPKey) {
    ...
    public String toString() {
        String ret = "<CFSecBuffISOTZoneH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
