// Description: Java 25 implementation of a ISOTZone history buffer primary key
...
/**
 *	CFSecBuffISOTZoneHPKey History Primary Key for ISOTZone
 *		requiredISOTZoneId	Required object attribute ISOTZoneId.
 */
public class CFSecBuffISOTZoneHPKey
	implements ICFSecISOTZoneHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffISOTZoneHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
