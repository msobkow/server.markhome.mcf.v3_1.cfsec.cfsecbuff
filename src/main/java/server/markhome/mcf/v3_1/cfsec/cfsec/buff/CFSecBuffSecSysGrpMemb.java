// Description: Java 25 implementation of a SecSysGrpMemb buffer
...
public class CFSecBuffSecSysGrpMemb
	implements ICFSecSecSysGrpMemb, Comparable<Object>, Serializable
{
	protected ICFSecSecSysGrpMembPKey pkey = new CFSecBuffSecSysGrpMembPKey();
	...
	public void setPKey(ICFSecSecSysGrpMembPKey pkey ) {
		...
		else if (!(pkey instanceof CFSecBuffSecSysGrpMembPKey)) {
			throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecSysGrpMembPKey");
		}
		this.pkey = (CFSecBuffSecSysGrpMembPKey)pkey;
	}
	...
	public void setRequiredParentUser(CFLibDbKeyHash256 argSecUserId) {
		getPKey().setRequiredParentUser(argSecUserId);
	}

	@Override
	public CFLibDbKeyHash256 getRequiredSecUserId() {
		return (getPKey().getRequiredParentUser().getRequiredSecUserId());
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecSysGrpMemb" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
