// Description: Java 25 implementation of a SecSession by FinishIdx index key buffer
...
public class CFSecBuffSecSessionByFinishIdxKey
	implements ICFSecSecSessionByFinishIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecSessionByFinishIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
