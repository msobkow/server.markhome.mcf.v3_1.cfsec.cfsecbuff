// Description: Java 25 implementation of a SecClusGrpInc history buffer primary key
	...
	implements ICFSecSecClusGrpIncHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecClusGrpIncHPKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpIncPKey, ICFSecSecClusGrpInc, ICFSecSecClusGrpIncHPKey, ICFSecSecClusGrpIncH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusGrpIncHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
