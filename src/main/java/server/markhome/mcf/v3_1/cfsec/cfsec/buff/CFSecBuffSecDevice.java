// Description: Java 25 implementation of a SecDevice buffer
...
public class CFSecBuffSecDevice
	implements ICFSecSecDevice, Comparable<Object>, Serializable
{
	protected ICFSecSecDevicePKey pkey = new CFSecBuffSecDevicePKey();
	...
	public CFSecBuffSecDevice() {
		pkey = new CFSecBuffSecDevicePKey();
	}
	...
	public void setPKey(ICFSecSecDevicePKey pkey ) {
		...
		else if (!(pkey instanceof CFSecBuffSecDevicePKey)) {
			throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecDevicePKey");
		}
		this.pkey = (CFSecBuffSecDevicePKey)pkey;
	}

	@Override
	public ICFSecSecUser getRequiredContainerSecUser() {
		return( getPKey().getRequiredContainerSecUser() );
	}
	
	@Override
	public void setRequiredContainerSecUser(ICFSecSecUser value) {
		getPKey().setRequiredContainerSecUser(value);
	}

	@Override
	public void setRequiredContainerSecUser(CFLibDbKeyHash256 argSecUserId) {
		getPKey().setRequiredContainerSecUser(argSecUserId);
	}

	@Override
	public CFLibDbKeyHash256 getRequiredSecUserId() {
		return (getPKey().getRequiredContainerSecUser().getRequiredSecUserId());
	}
	...
	public String toString() {
		String ret = "<CFSecBuffSecDevice" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
