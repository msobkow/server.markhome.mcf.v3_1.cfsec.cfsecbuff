// Description: Java 25 implementation of a SecClusRoleMemb history buffer primary key
...
/**
 *	CFSecBuffSecClusRoleMembHPKey History Primary Key for SecClusRoleMemb
 *		requiredSecClusRoleId	Required object attribute SecClusRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecBuffSecClusRoleMembHPKey
	implements ICFSecSecClusRoleMembHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusRoleMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
