// Description: Java 25 implementation of a SecTentGrp history buffer object
...
public class CFSecBuffSecTentGrpH
    implements ICFSecSecTentGrpH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFSecSecTentGrpHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecTentGrpHPKey) {
                this.pkey = (CFSecBuffSecTentGrpHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecTentGrpHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecTentGrpH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
