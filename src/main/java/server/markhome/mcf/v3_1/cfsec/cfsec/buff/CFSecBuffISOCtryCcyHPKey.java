// Description: Java 25 implementation of a ISOCtryCcy history buffer primary key
...
/**
 *	CFSecBuffISOCtryCcyHPKey History Primary Key for ISOCtryCcy
	...
	implements ICFSecISOCtryCcyHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffISOCtryCcyHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
