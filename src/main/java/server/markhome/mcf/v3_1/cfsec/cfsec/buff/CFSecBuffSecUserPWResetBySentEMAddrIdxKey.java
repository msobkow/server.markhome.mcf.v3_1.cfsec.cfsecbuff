// Description: Java 25 implementation of a SecUserPWReset by SentEMAddrIdx index key buffer
	...
	implements ICFSecSecUserPWResetBySentEMAddrIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserPWResetBySentEMAddrIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
