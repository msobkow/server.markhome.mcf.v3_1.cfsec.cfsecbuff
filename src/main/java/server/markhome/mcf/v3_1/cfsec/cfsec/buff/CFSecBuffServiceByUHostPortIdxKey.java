// Description: Java 25 implementation of a Service by UHostPortIdx index key buffer
...
public class CFSecBuffServiceByUHostPortIdxKey
	implements ICFSecServiceByUHostPortIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffServiceByUHostPortIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffServiceByUHostPortIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
