// Description: Java 25 implementation of a Service history buffer primary key
...
/**
 *	CFSecBuffServiceHPKey History Primary Key for Service
 *		requiredServiceId	Required object attribute ServiceId.
 */
public class CFSecBuffServiceHPKey
	implements ICFSecServiceHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffServiceHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
