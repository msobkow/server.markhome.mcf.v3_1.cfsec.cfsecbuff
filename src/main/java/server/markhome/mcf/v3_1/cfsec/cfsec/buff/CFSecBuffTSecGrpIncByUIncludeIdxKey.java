// Description: Java 25 implementation of a TSecGrpInc by UIncludeIdx index key buffer
...
public class CFSecBuffTSecGrpIncByUIncludeIdxKey
	implements ICFSecTSecGrpIncByUIncludeIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffTSecGrpIncByUIncludeIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffTSecGrpIncByUIncludeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
