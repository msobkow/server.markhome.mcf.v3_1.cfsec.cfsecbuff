// Description: Java 25 implementation of a ISOCcy history buffer object
    ...
    implements ICFSecISOCcyH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFSecISOCcyHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffISOCcyHPKey) {
    ...
    public String toString() {
        String ret = "<CFSecBuffISOCcyH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
