// Description: Java 25 implementation of a SecClusRoleMemb primary key buffer object
...
/*
 *	CFSecBuffSecClusRoleMembPKey Primary Key for SecClusRoleMemb buffers
	...
	implements ICFSecSecClusRoleMembPKey, Comparable<ICFSecSecClusRoleMembPKey>, Serializable
{
	...
	public void setRequiredContainerRole(ICFSecSecClusRole argObj) {
		if(argObj == null) {
			...
			requiredSecClusRoleId = argObj.getRequiredSecClusRoleId();
		}
	...
	public void setRequiredContainerRole(CFLibDbKeyHash256 argSecClusRoleId) {
		requiredSecClusRoleId = argSecClusRoleId;
	}
	@Override
