// Description: Java 25 implementation of a TSecGrpMemb by TenantIdx index key buffer
...
public class CFSecBuffTSecGrpMembByTenantIdxKey
	implements ICFSecTSecGrpMembByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFSecBuffTSecGrpMembByTenantIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffTSecGrpMembByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
