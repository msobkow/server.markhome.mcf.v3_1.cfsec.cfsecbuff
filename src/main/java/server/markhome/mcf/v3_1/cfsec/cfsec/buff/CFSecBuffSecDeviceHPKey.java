// Description: Java 25 implementation of a SecDevice history buffer primary key
...
/**
 *	CFSecBuffSecDeviceHPKey History Primary Key for SecDevice
	...
	implements ICFSecSecDeviceHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecDeviceHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecDeviceHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
