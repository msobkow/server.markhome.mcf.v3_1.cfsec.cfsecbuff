// Description: Java 25 implementation of a SecGroup history buffer primary key
...
/**
 *	CFSecBuffSecGroupHPKey History Primary Key for SecGroup
 *		requiredSecGroupId	Required object attribute SecGroupId.
 */
public class CFSecBuffSecGroupHPKey
	implements ICFSecSecGroupHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecGroupHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
