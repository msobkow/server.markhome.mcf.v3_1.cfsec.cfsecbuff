// Description: Java 25 implementation of a Tenant history buffer primary key
...
/**
 *	CFSecBuffTenantHPKey History Primary Key for Tenant
 *		requiredId	Required object attribute Id.
 */
public class CFSecBuffTenantHPKey
	implements ICFSecTenantHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffTenantHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
