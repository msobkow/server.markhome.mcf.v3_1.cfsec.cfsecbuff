// Description: Java 25 implementation of a Tenant by ClusterIdx index key buffer
...
public class CFSecBuffTenantByClusterIdxKey
	implements ICFSecTenantByClusterIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffTenantByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
