// Description: Java 25 implementation of a HostNode buffer
...
public class CFSecBuffHostNode
	implements ICFSecHostNode, Comparable<Object>, Serializable
{
	...
	public List<ICFSecService> getOptionalComponentsService() {
		...
		if (targetBackingSchema == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalComponentsService", 0, "ICFSecSchema.getBackingCFSec()");
		}
		ICFSecServiceTable targetTable = targetBackingSchema.getTableService();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalComponentsService", 0, "ICFSecSchema.getBackingCFSec().getTableService()");
		}
		ICFSecService[] targetArr = targetTable.readDerivedByHostIdx(null, getRequiredHostNodeId());
		if( targetArr != null ) {
	...
	public String toString() {
		String ret = "<CFSecBuffHostNode" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
