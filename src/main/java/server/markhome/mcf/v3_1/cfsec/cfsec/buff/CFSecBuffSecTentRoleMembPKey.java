// Description: Java 25 implementation of a SecTentRoleMemb primary key buffer object
...
/*
 *	CFSecBuffSecTentRoleMembPKey Primary Key for SecTentRoleMemb buffers
	...
	implements ICFSecSecTentRoleMembPKey, Comparable<ICFSecSecTentRoleMembPKey>, Serializable
{
	...
	public void setRequiredContainerRole(ICFSecSecTentRole argObj) {
		if(argObj == null) {
			...
			requiredSecTentRoleId = argObj.getRequiredSecTentRoleId();
		}
