// Description: Java 25 implementation of a SecGrpInc by UIncludeIdx index key buffer
...
public class CFSecBuffSecGrpIncByUIncludeIdxKey
	implements ICFSecSecGrpIncByUIncludeIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecGrpIncByUIncludeIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecGrpIncByUIncludeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
