// Description: Java 25 implementation of a SecUser by DefDevIdx index key buffer
...
public class CFSecBuffSecUserByDefDevIdxKey
	implements ICFSecSecUserByDefDevIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecUserByDefDevIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserByDefDevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
