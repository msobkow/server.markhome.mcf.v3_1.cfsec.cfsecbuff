// Description: Java 25 implementation of a SecUserPWReset by NewAcctIdx index key buffer
...
public class CFSecBuffSecUserPWResetByNewAcctIdxKey
	implements ICFSecSecUserPWResetByNewAcctIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserPWResetByNewAcctIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
