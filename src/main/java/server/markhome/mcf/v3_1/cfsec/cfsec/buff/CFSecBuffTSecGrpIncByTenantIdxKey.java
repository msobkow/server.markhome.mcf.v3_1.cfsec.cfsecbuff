// Description: Java 25 implementation of a TSecGrpInc by TenantIdx index key buffer
...
public class CFSecBuffTSecGrpIncByTenantIdxKey
	implements ICFSecTSecGrpIncByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFSecBuffTSecGrpIncByTenantIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffTSecGrpIncByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
