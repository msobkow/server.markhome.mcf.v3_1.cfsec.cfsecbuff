// Description: Java 25 implementation of a Service by TypeIdx index key buffer
	...
	implements ICFSecServiceByTypeIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffServiceByTypeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
