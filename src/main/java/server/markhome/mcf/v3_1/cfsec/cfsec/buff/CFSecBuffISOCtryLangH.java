// Description: Java 25 implementation of a ISOCtryLang history buffer object
...
public class CFSecBuffISOCtryLangH
    implements ICFSecISOCtryLangH, Comparable<Object>, Serializable
{
    ...
    public CFSecBuffISOCtryLangH() {
            ...
            pkey = new CFSecBuffISOCtryLangHPKey();
    }
    ...
    public void setPKey( ICFSecISOCtryLangHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffISOCtryLangHPKey) {
                this.pkey = (CFSecBuffISOCtryLangHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffISOCtryLangHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffISOCtryLangH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
