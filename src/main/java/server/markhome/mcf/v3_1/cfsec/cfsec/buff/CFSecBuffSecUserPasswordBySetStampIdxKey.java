// Description: Java 25 implementation of a SecUserPassword by SetStampIdx index key buffer
	...
	implements ICFSecSecUserPasswordBySetStampIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecUserPasswordBySetStampIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
