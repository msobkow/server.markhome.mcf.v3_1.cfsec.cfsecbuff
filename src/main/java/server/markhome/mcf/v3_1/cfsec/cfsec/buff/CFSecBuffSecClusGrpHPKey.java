// Description: Java 25 implementation of a SecClusGrp history buffer primary key
...
/**
 *	CFSecBuffSecClusGrpHPKey History Primary Key for SecClusGrp
	...
	implements ICFSecSecClusGrpHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusGrpHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
