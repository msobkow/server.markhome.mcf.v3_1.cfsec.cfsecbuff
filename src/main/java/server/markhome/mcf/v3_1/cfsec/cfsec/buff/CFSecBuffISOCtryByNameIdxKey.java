// Description: Java 25 implementation of a ISOCtry by NameIdx index key buffer
...
public class CFSecBuffISOCtryByNameIdxKey
	implements ICFSecISOCtryByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffISOCtryByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
