// Description: Java 25 implementation of a ISOCtryCcy history buffer object
...
public class CFSecBuffISOCtryCcyH
    implements ICFSecISOCtryCcyH, Comparable<Object>, Serializable
{
    ...
    public CFSecBuffISOCtryCcyH() {
            ...
            pkey = new CFSecBuffISOCtryCcyHPKey();
    }
    ...
    public void setPKey( ICFSecISOCtryCcyHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffISOCtryCcyHPKey) {
    ...
    public String toString() {
        String ret = "<CFSecBuffISOCtryCcyH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
