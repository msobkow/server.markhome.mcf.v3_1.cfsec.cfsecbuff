// Description: Java 25 implementation of a SecClusRole history buffer object
...
public class CFSecBuffSecClusRoleH
    implements ICFSecSecClusRoleH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFSecSecClusRoleHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecClusRoleHPKey) {
                this.pkey = (CFSecBuffSecClusRoleHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecClusRoleHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecClusRoleH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
