// Description: Java 25 implementation of a SecSysGrpInc history buffer primary key
	...
	implements ICFSecSecSysGrpIncHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecSysGrpIncHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
