// Description: Java 25 implementation of a SecTentRoleMemb history buffer primary key
...
/**
 *	CFSecBuffSecTentRoleMembHPKey History Primary Key for SecTentRoleMemb
 *		requiredSecTentRoleId	Required object attribute SecTentRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecBuffSecTentRoleMembHPKey
	implements ICFSecSecTentRoleMembHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecTentRoleMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
