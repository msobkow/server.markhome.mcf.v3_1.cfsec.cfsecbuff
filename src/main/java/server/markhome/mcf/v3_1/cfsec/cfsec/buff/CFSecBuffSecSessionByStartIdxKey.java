// Description: Java 25 implementation of a SecSession by StartIdx index key buffer
...
public class CFSecBuffSecSessionByStartIdxKey
	implements ICFSecSecSessionByStartIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecSessionByStartIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
