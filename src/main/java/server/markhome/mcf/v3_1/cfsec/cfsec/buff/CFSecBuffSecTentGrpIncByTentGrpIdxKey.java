// Description: Java 25 implementation of a SecTentGrpInc by TentGrpIdx index key buffer
...
public class CFSecBuffSecTentGrpIncByTentGrpIdxKey
	implements ICFSecSecTentGrpIncByTentGrpIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecTentGrpId;
	public CFSecBuffSecTentGrpIncByTentGrpIdxKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecTentGrpIncByTentGrpIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
