// Description: Java 25 implementation of a Cluster history buffer primary key
...
/**
 *	CFSecBuffClusterHPKey History Primary Key for Cluster
	...
	implements ICFSecClusterHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffClusterHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
