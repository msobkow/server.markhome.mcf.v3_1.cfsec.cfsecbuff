// Description: Java 25 implementation of a SecClusGrpMemb primary key buffer object
...
/*
 *	CFSecBuffSecClusGrpMembPKey Primary Key for SecClusGrpMemb buffers
	...
	implements ICFSecSecClusGrpMembPKey, Comparable<ICFSecSecClusGrpMembPKey>, Serializable
{
	...
	public ICFSecSecClusGrp getRequiredContainerGroup() {
		...
		ICFSecSecClusGrp targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredSecClusGrpId());
		return(targetRec);
	}
	@Override
	public void setRequiredContainerGroup(ICFSecSecClusGrp argObj) {
		if(argObj == null) {
			...
			requiredSecClusGrpId = argObj.getRequiredSecClusGrpId();
		}
