// Description: Java 25 implementation of a SecSysGrpMemb history buffer primary key
	...
	implements ICFSecSecSysGrpMembHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecSysGrpMembHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecSysGrpMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
