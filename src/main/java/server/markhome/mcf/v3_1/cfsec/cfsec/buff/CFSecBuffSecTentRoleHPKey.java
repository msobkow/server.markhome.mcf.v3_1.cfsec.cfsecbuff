// Description: Java 25 implementation of a SecTentRole history buffer primary key
...
/**
 *	CFSecBuffSecTentRoleHPKey History Primary Key for SecTentRole
 *		requiredSecTentRoleId	Required object attribute SecTentRoleId.
 */
public class CFSecBuffSecTentRoleHPKey
	implements ICFSecSecTentRoleHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecTentRoleHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecTentRoleHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
