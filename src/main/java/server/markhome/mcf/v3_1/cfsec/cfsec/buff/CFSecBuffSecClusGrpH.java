// Description: Java 25 implementation of a SecClusGrp history buffer object
...
public class CFSecBuffSecClusGrpH
    implements ICFSecSecClusGrpH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFSecSecClusGrpHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecBuffSecClusGrpHPKey) {
                this.pkey = (CFSecBuffSecClusGrpHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecBuffSecClusGrpHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecBuffSecClusGrpH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
