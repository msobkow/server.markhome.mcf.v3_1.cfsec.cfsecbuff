// Description: Java 25 implementation of a SecClusRole history buffer primary key
...
/**
 *	CFSecBuffSecClusRoleHPKey History Primary Key for SecClusRole
 *		requiredSecClusRoleId	Required object attribute SecClusRoleId.
 */
public class CFSecBuffSecClusRoleHPKey
	implements ICFSecSecClusRoleHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecBuffSecClusRoleHPKey() {
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusRoleHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
