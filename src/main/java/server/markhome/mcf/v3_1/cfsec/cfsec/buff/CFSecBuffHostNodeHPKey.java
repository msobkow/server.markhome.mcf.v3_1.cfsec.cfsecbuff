// Description: Java 25 implementation of a HostNode history buffer primary key
...
/**
 *	CFSecBuffHostNodeHPKey History Primary Key for HostNode
 *		requiredHostNodeId	Required object attribute HostNodeId.
 */
public class CFSecBuffHostNodeHPKey
	implements ICFSecHostNodeHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffHostNodeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
