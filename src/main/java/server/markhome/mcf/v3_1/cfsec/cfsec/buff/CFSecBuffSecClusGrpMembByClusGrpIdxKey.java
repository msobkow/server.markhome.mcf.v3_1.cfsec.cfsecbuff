// Description: Java 25 implementation of a SecClusGrpMemb by ClusGrpIdx index key buffer
	...
	implements ICFSecSecClusGrpMembByClusGrpIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusGrpMembByClusGrpIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
