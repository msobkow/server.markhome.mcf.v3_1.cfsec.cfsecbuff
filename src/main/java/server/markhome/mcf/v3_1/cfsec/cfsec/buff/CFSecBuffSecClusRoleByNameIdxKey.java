// Description: Java 25 implementation of a SecClusRole by NameIdx index key buffer
...
public class CFSecBuffSecClusRoleByNameIdxKey
	implements ICFSecSecClusRoleByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecBuffSecClusRoleByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
